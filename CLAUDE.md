...
`.agents/skills/`: `lorairo-repository-pattern`, `interface-design`, `lorairo-qt-widget`, `lorairo-test-generator`, `lazy-import-refactor`, `agent-pr-maintainer` (PR保守ポリシー), `agent-pr-autoloop` (PR保守ループ自走)
