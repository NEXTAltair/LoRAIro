...
- ワークスペース: 既存3ペインレイアウト（右カラムのアノテーション制御は削除）
- バッチタグ: 2カラム（ステージング画像グリッド + 操作パネル + タグテーブル）
...
**午後（4時間）: ウィジェット統合**
- [ ] BatchTagAddWidget配置
- [ ] AnnotationDataDisplayWidget追加（タグテーブル表示）
