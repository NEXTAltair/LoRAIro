...
TagStatistics (DB-wide) currently computes summary totals (total/alias/non-alias), usage stats by format excluding alias/deprecated, type distribution by format excluding alias/deprecated, and translations per tag with language set.
