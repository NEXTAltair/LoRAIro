...
LoRAIro は pytest-bdd (>=8.1) を使う。詳細な使い方・コード例は `docs/testing.md` の「BDD振る舞い仕様テスト」セクション参照。要点:
...
|---|---|---|
| LoRAIro Unit Tests | repo root | `-m "not gui_show and not calls_real_webapi and not downloads_and_runs_model and not slow"` |
