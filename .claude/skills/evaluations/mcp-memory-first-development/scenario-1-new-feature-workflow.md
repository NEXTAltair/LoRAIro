...
- Need to leverage both Serena (short-term) and Cipher (long-term) memory
...
2. Should guide user through 3-phase workflow:
   ...
   **Phase 1: Before Implementation**
   - `mcp__cipher__cipher_memory_search` for "export patterns" or "CSV export"
   ...
   **Phase 3: After Implementation**
   - `mcp__cipher__cipher_extract_and_operate_memory` to store design knowledge
...
2. Check Phase 1 (Before Implementation):
   - `cipher_memory_search` used with relevant query
