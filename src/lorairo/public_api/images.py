...
from lorairo.public_api.exceptions import ImageRegistrationError, ProjectNotFoundError
...
def register_images(
    ...
    使用例:
        >>> from pathlib import Path
        >>> from lorairo.public_api import register_images
        >>>
...
def detect_duplicate_images(
    ...
    使用例:
        >>> from lorairo.public_api import detect_duplicate_images
        >>>
