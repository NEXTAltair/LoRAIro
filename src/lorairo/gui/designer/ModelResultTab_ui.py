...
class Ui_ModelResultTab:
    def setupUi(self, ModelResultTab):
        ...
        self.frameErrorHeader.setStyleSheet(
            "QFrame {\n"
        ...
        self.horizontalSpacerError = QSpacerItem(
            40, 20, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum
        )
        ...
        self.textEditErrorMessage.setStyleSheet(
            "QTextEdit {\n"
        ...
        self.verticalSpacerError = QSpacerItem(
    ...
    def retranslateUi(self, ModelResultTab):
        self.labelModelName.setText(
            QCoreApplication.translate("ModelResultTab", "\u30e2\u30c7\u30eb\u540d: GPT-4o", None)
        )
        self.labelProcessingTime.setText(
            QCoreApplication.translate("ModelResultTab", "\u51e6\u7406\u6642\u9593: 2.3s", None)
        )
        ...
        self.labelTagsPlaceholder.setText(
            QCoreApplication.translate("ModelResultTab", "\u30bf\u30b0\u306a\u3057", None)
        )
        self.groupBoxCaptions.setTitle(
            QCoreApplication.translate("ModelResultTab", "\u30ad\u30e3\u30d7\u30b7\u30e7\u30f3", None)
        )
        self.textEditCaptions.setPlaceholderText(
            QCoreApplication.translate(
                "ModelResultTab", "\u30ad\u30e3\u30d7\u30b7\u30e7\u30f3\u306a\u3057", None
            )
        )
        self.groupBoxScores.setTitle(
            QCoreApplication.translate("ModelResultTab", "\u30b9\u30b3\u30a2", None)
        )
        ...
        self.groupBoxErrorDetails.setTitle(
            QCoreApplication.translate("ModelResultTab", "\u30a8\u30e9\u30fc\u8a73\u7d30", None)
        )
        self.textEditErrorMessage.setPlaceholderText(
            QCoreApplication.translate(
                "ModelResultTab",
                "\u30a8\u30e9\u30fc\u60c5\u5831\u304c\u8aad\u307f\u8fbc\u307e\u308c\u307e\u3059...",
                None,
