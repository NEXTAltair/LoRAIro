...
class Ui_DatasetExportWidget:
    ...
    def retranslateUi(self, DatasetExportWidget):
        DatasetExportWidget.setWindowTitle(
            QCoreApplication.translate("DatasetExportWidget", "Dataset Export", None)
        )
        self.imageCountLabel.setText("")
        self.exportGroupBox.setTitle(
            QCoreApplication.translate("DatasetExportWidget", "Export Settings", None)
        )
        self.exportFormatLabel.setText(
            QCoreApplication.translate("DatasetExportWidget", "Export Format:", None)
        )
        ...
        self.latestcheckBox.setText(
            QCoreApplication.translate(
                "DatasetExportWidget",
                "\u6700\u5f8c\u306b\u66f4\u65b0\u3055\u308c\u305f\u30a2\u30ce\u30c6\u30fc\u30b7\u30e7\u30f3\u3060\u3051\u3092\u51fa\u529b\u3059\u308b",
                None,
            )
        )
        self.MergeCaptionWithTagscheckBox.setText(
            QCoreApplication.translate(
                "DatasetExportWidget",
                'caption\u3068\u3057\u3066\u4fdd\u5b58\u3055\u308c\u305f\u6587\u5b57\u5217\u3082 ".tag" \u306b\u4fdd\u5b58\u3059\u308b',
                None,
            )
        )
