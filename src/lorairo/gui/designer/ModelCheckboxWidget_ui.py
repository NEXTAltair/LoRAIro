...
from PySide6.QtWidgets import QApplication, QCheckBox, QHBoxLayout, QLabel, QSizePolicy, QWidget


class Ui_ModelCheckboxWidget:
    def setupUi(self, ModelCheckboxWidget):
        if not ModelCheckboxWidget.objectName():
            ModelCheckboxWidget.setObjectName("ModelCheckboxWidget")
        ...
        self.labelModelName.setAlignment(
            Qt.AlignmentFlag.AlignLeading | Qt.AlignmentFlag.AlignLeft | Qt.AlignmentFlag.AlignVCenter
        )
        self.labelModelName.setStyleSheet("QLabel {\n    color: #333;\n    padding: 2px 4px;\n}")
        ...
        self.labelProvider.setStyleSheet(
            "QLabel {\n"
        ...
        self.labelCapabilities.setStyleSheet(
            "QLabel {\n"
    ...
    def retranslateUi(self, ModelCheckboxWidget):
        ModelCheckboxWidget.setWindowTitle(
            QCoreApplication.translate("ModelCheckboxWidget", "Model Checkbox", None)
        )
        self.checkboxModel.setText("")
        self.labelModelName.setText(QCoreApplication.translate("ModelCheckboxWidget", "Model Name", None))
        self.labelProvider.setText(QCoreApplication.translate("ModelCheckboxWidget", "Provider", None))
        self.labelCapabilities.setText(
            QCoreApplication.translate("ModelCheckboxWidget", "capabilities", None)
        )
