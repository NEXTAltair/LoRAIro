...
"}")
        ...
        self.labelProvider.setStyleSheet("QLabel {\n"
...
"}")
        ...
        self.labelCapabilities.setStyleSheet("QLabel {\n"
...
"}")
    ...
    def retranslateUi(self, ModelCheckboxWidget):
        ModelCheckboxWidget.setWindowTitle(QCoreApplication.translate("ModelCheckboxWidget", "Model Checkbox", None))
        ...
        self.labelCapabilities.setText(QCoreApplication.translate("ModelCheckboxWidget", "capabilities", None))
    # retranslateUi
