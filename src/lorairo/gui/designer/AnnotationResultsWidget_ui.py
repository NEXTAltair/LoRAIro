...
class Ui_AnnotationResultsWidget:
    ...
    def retranslateUi(self, AnnotationResultsWidget):
        AnnotationResultsWidget.setWindowTitle(
            QCoreApplication.translate("AnnotationResultsWidget", "Annotation Results", None)
        )
        self.labelResultsTitle.setText(
            QCoreApplication.translate(
                "AnnotationResultsWidget", "\u30a2\u30ce\u30c6\u30fc\u30b7\u30e7\u30f3\u7d50\u679c", None
            )
        )
        ___qtablewidgetitem = self.tableWidgetCaption.horizontalHeaderItem(0)
        ___qtablewidgetitem.setText(
            QCoreApplication.translate("AnnotationResultsWidget", "\u30e2\u30c7\u30eb\u540d", None)
        )
        ___qtablewidgetitem1 = self.tableWidgetCaption.horizontalHeaderItem(1)
        ___qtablewidgetitem1.setText(
            QCoreApplication.translate(
                "AnnotationResultsWidget", "\u30ad\u30e3\u30d7\u30b7\u30e7\u30f3", None
            )
        )
        self.tabWidgetResults.setTabText(
            self.tabWidgetResults.indexOf(self.tabCaption),
            QCoreApplication.translate(
                "AnnotationResultsWidget", "\u30ad\u30e3\u30d7\u30b7\u30e7\u30f3", None
            ),
        )
        ...
        ___qtablewidgetitem3.setText(
            QCoreApplication.translate("AnnotationResultsWidget", "\u30bf\u30b0", None)
        )
        self.tabWidgetResults.setTabText(
            self.tabWidgetResults.indexOf(self.tabTags),
            QCoreApplication.translate("AnnotationResultsWidget", "\u30bf\u30b0", None),
        )
        ...
        ___qtablewidgetitem5.setText(
            QCoreApplication.translate("AnnotationResultsWidget", "\u30b9\u30b3\u30a2\u5024", None)
        )
        ___qtablewidgetitem6 = self.tableWidgetScores.horizontalHeaderItem(2)
        ___qtablewidgetitem6.setText(
            QCoreApplication.translate(
                "AnnotationResultsWidget", "\u30b9\u30b3\u30a2\u30bf\u30a4\u30d7", None
            )
        )
        self.tabWidgetResults.setTabText(
            self.tabWidgetResults.indexOf(self.tabScores),
            QCoreApplication.translate("AnnotationResultsWidget", "\u30b9\u30b3\u30a2", None),
        )
