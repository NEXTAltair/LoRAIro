...
class Ui_AnnotationDataDisplayWidget:
    ...
    def retranslateUi(self, AnnotationDataDisplayWidget):
        AnnotationDataDisplayWidget.setWindowTitle(QCoreApplication.translate("AnnotationDataDisplayWidget", "Annotation Data Display", None))
        self.groupBoxTags.setTitle(QCoreApplication.translate("AnnotationDataDisplayWidget", "\u30bf\u30b0", None))
        ...
        ___qtablewidgetitem1.setText(QCoreApplication.translate("AnnotationDataDisplayWidget", "Model", None))
        ___qtablewidgetitem2 = self.tableWidgetTags.horizontalHeaderItem(2)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("AnnotationDataDisplayWidget", "Source", None))
        ___qtablewidgetitem3 = self.tableWidgetTags.horizontalHeaderItem(3)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("AnnotationDataDisplayWidget", "Confidence", None))
        ___qtablewidgetitem4 = self.tableWidgetTags.horizontalHeaderItem(4)
        ___qtablewidgetitem4.setText(QCoreApplication.translate("AnnotationDataDisplayWidget", "Edited", None))
        self.groupBoxCaption.setTitle(QCoreApplication.translate("AnnotationDataDisplayWidget", "\u30ad\u30e3\u30d7\u30b7\u30e7\u30f3", None))
        self.textEditCaption.setPlaceholderText(QCoreApplication.translate("AnnotationDataDisplayWidget", "\u30ad\u30e3\u30d7\u30b7\u30e7\u30f3\u304c\u8868\u793a\u3055\u308c\u307e\u3059", None))
        self.textEditCaption.setStyleSheet(QCoreApplication.translate("AnnotationDataDisplayWidget", "QTextEdit {\n"
"    font-size: 10px;\n"
...
"    color: palette(text);\n"
"}", None))
        self.groupBoxScores.setTitle(QCoreApplication.translate("AnnotationDataDisplayWidget", "\u54c1\u8cea\u30b9\u30b3\u30a2", None))
        self.labelScoreType.setText(QCoreApplication.translate("AnnotationDataDisplayWidget", "Aesthetic:", None))
        self.labelScoreTypeValue.setText(QCoreApplication.translate("AnnotationDataDisplayWidget", "-", None))
        self.labelScoreTypeValue.setStyleSheet(QCoreApplication.translate("AnnotationDataDisplayWidget", "font-size: 10px; font-weight: bold; color: palette(text);", None))
        self.labelOverallScore.setText(QCoreApplication.translate("AnnotationDataDisplayWidget", "\u30b9\u30b3\u30a2:", None))
        self.labelOverallValue.setText(QCoreApplication.translate("AnnotationDataDisplayWidget", "0", None))
        self.labelOverallValue.setStyleSheet(QCoreApplication.translate("AnnotationDataDisplayWidget", "font-size: 10px; font-weight: bold; color: palette(text);", None))
    # retranslateUi
