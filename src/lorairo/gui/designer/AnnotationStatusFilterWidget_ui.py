...
class Ui_AnnotationStatusFilterWidget:
    def setupUi(self, AnnotationStatusFilterWidget):
        ...
        self.labelCompletedCount.setAlignment(
        ...
        self.labelErrorCount.setAlignment(
            Qt.AlignmentFlag.AlignRight | Qt.AlignmentFlag.AlignTrailing | Qt.AlignmentFlag.AlignVCenter
        )
    ...
    def retranslateUi(self, AnnotationStatusFilterWidget):
        AnnotationStatusFilterWidget.setWindowTitle(
            QCoreApplication.translate("AnnotationStatusFilterWidget", "Annotation Status Filter", None)
        )
        self.groupBoxStatusFilter.setTitle(
        ...
        self.checkBoxError.setText(
            QCoreApplication.translate("AnnotationStatusFilterWidget", "\u30a8\u30e9\u30fc", None)
        )
        self.labelCompletedCount.setText(
            QCoreApplication.translate("AnnotationStatusFilterWidget", "(0)", None)
        )
        self.checkBoxCompleted.setText(
            QCoreApplication.translate("AnnotationStatusFilterWidget", "\u5b8c\u4e86", None)
        )
        self.labelErrorCount.setText(
            QCoreApplication.translate("AnnotationStatusFilterWidget", "(0)", None)
        )
        # if QT_CONFIG(tooltip)
        self.pushButtonRefresh.setToolTip(
            QCoreApplication.translate(
                "AnnotationStatusFilterWidget", "\u7d71\u8a08\u60c5\u5831\u3092\u66f4\u65b0", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.pushButtonRefresh.setText(
            QCoreApplication.translate("AnnotationStatusFilterWidget", "\u66f4\u65b0", None)
        )
