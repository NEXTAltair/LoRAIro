...
class Ui_AnnotationStatusFilterWidget(object):
    def setupUi(self, AnnotationStatusFilterWidget):
        ...
        self.groupBoxStatusFilter.setObjectName(u"groupBoxStatusFilter")
        self.gridLayoutStatus = QGridLayout(self.groupBoxStatusFilter)
        self.gridLayoutStatus.setSpacing(3)
        self.gridLayoutStatus.setObjectName(u"gridLayoutStatus")
        self.checkBoxError = QCheckBox(self.groupBoxStatusFilter)
        self.checkBoxError.setObjectName(u"checkBoxError")
        ...
        self.labelCompletedCount.setObjectName(u"labelCompletedCount")
        ...
        self.checkBoxCompleted.setObjectName(u"checkBoxCompleted")
        ...
        self.labelErrorCount.setObjectName(u"labelErrorCount")
    ...
    def retranslateUi(self, AnnotationStatusFilterWidget):
        ...
        self.labelCompletedCount.setText(QCoreApplication.translate("AnnotationStatusFilterWidget", u"(0)", None))
        self.checkBoxCompleted.setText(QCoreApplication.translate("AnnotationStatusFilterWidget", u"\u5b8c\u4e86", None))
        self.labelErrorCount.setText(QCoreApplication.translate("AnnotationStatusFilterWidget", u"(0)", None))
#if QT_CONFIG(tooltip)
        self.pushButtonRefresh.setToolTip(QCoreApplication.translate("AnnotationStatusFilterWidget", u"\u7d71\u8a08\u60c5\u5831\u3092\u66f4\u65b0", None))
#endif // QT_CONFIG(tooltip)
        self.pushButtonRefresh.setText(QCoreApplication.translate("AnnotationStatusFilterWidget", u"\u66f4\u65b0", None))
    # retranslateUi
