...
class Ui_FilterSearchPanel:
    def setupUi(self, FilterSearchPanel):
        ...
        self.ratingFilterLayout.setObjectName("ratingFilterLayout")
        ...
        self.checkboxIncludeUnrated.setObjectName("checkboxIncludeUnrated")
    ...
    def retranslateUi(self, FilterSearchPanel):
        ...
        self.ratingGroup.setTitle(QCoreApplication.translate("FilterSearchPanel", "\u30ec\u30fc\u30c6\u30a3\u30f3\u30b0", None))
        self.ratingLabel.setText(QCoreApplication.translate("FilterSearchPanel", "\u30ec\u30fc\u30c6\u30a3\u30f3\u30b0:", None))
        self.comboRating.setItemText(0, QCoreApplication.translate("FilterSearchPanel", "\u5168\u3066", None))
        self.comboRating.setItemText(1, QCoreApplication.translate("FilterSearchPanel", "PG (\u5168\u5e74\u9f62)", None))
        self.comboRating.setItemText(2, QCoreApplication.translate("FilterSearchPanel", "PG-13 (\u8efd\u5fae\u306a\u8868\u73fe)", None))
        self.comboRating.setItemText(3, QCoreApplication.translate("FilterSearchPanel", "R (\u4e2d\u7a0b\u5ea6)", None))
        self.comboRating.setItemText(4, QCoreApplication.translate("FilterSearchPanel", "X (\u5f37\u3044\u8868\u73fe)", None))
        self.comboRating.setItemText(5, QCoreApplication.translate("FilterSearchPanel", "XXX (\u904e\u6fc0\u306a\u8868\u73fe)", None))

        self.checkboxIncludeUnrated.setText(QCoreApplication.translate("FilterSearchPanel", "\u672a\u8a55\u4fa1\u753b\u50cf\u3092\u542b\u3080", None))
