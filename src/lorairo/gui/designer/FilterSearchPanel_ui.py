...
class Ui_FilterSearchPanel(object):
    def setupUi(self, FilterSearchPanel: QWidget) -> None:
        ...
        self.ratingChipPlaceholder = QWidget(self.ratingGroup)
        self.ratingChipPlaceholder.setObjectName(u"ratingChipPlaceholder")

        self.ratingFilterLayout.addWidget(self.ratingChipPlaceholder)
        ...
        self.aiRatingChipPlaceholder = QWidget(self.ratingGroup)
        self.aiRatingChipPlaceholder.setObjectName(u"aiRatingChipPlaceholder")

        self.aiRatingFilterLayout.addWidget(self.aiRatingChipPlaceholder)
        ...
        self.ratingCombineLayout = QHBoxLayout()
        self.ratingCombineLayout.setObjectName(u"ratingCombineLayout")
        self.ratingCombineLabel = QLabel(self.ratingGroup)
        self.ratingCombineLabel.setObjectName(u"ratingCombineLabel")

        self.ratingCombineLayout.addWidget(self.ratingCombineLabel)

        self.ratingCombinePlaceholder = QWidget(self.ratingGroup)
        self.ratingCombinePlaceholder.setObjectName(u"ratingCombinePlaceholder")

        self.ratingCombineLayout.addWidget(self.ratingCombinePlaceholder)

        self.ratingCombineSpacer = QSpacerItem(40, 20, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)

        self.ratingCombineLayout.addItem(self.ratingCombineSpacer)


        self.ratingLayout.addLayout(self.ratingCombineLayout)
    ...
    def retranslateUi(self, FilterSearchPanel: QWidget) -> None:
        ...
        self.ratingCombineLabel.setText(QCoreApplication.translate("FilterSearchPanel", u"\u624b\u52d5\u00d7AI\u306e\u7d44\u5408\u305b:", None))
