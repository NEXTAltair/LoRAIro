...
class Ui_FilterSearchPanel(object):
    ...
    def retranslateUi(self, FilterSearchPanel: QWidget) -> None:
        ...
        self.comboRating.setItemText(0, QCoreApplication.translate("FilterSearchPanel", u"----", None))
        self.comboRating.setItemText(1, QCoreApplication.translate("FilterSearchPanel", u"\u30ec\u30fc\u30c6\u30a3\u30f3\u30b0\u6e08\u307f", None))
        self.comboRating.setItemText(2, QCoreApplication.translate("FilterSearchPanel", u"\u672a\u8a2d\u5b9a\u306e\u307f", None))
        self.comboRating.setItemText(3, QCoreApplication.translate("FilterSearchPanel", u"PG (\u5168\u5e74\u9f62)", None))
        self.comboRating.setItemText(4, QCoreApplication.translate("FilterSearchPanel", u"PG-13 (\u8efd\u5fae\u306a\u8868\u73fe)", None))
        self.comboRating.setItemText(5, QCoreApplication.translate("FilterSearchPanel", u"R (\u4e2d\u7a0b\u5ea6)", None))
        self.comboRating.setItemText(6, QCoreApplication.translate("FilterSearchPanel", u"X (\u5f37\u3044\u8868\u73fe)", None))
        self.comboRating.setItemText(7, QCoreApplication.translate("FilterSearchPanel", u"XXX (\u904e\u6fc0\u306a\u8868\u73fe)", None))

        self.aiRatingLabel.setText(QCoreApplication.translate("FilterSearchPanel", u"AI\u30ec\u30fc\u30c6\u30a3\u30f3\u30b0:", None))
        self.comboAIRating.setItemText(0, QCoreApplication.translate("FilterSearchPanel", u"----", None))
        self.comboAIRating.setItemText(1, QCoreApplication.translate("FilterSearchPanel", u"\u30ec\u30fc\u30c6\u30a3\u30f3\u30b0\u6e08\u307f", None))
        self.comboAIRating.setItemText(2, QCoreApplication.translate("FilterSearchPanel", u"\u672a\u8a2d\u5b9a\u306e\u307f", None))
        self.comboAIRating.setItemText(3, QCoreApplication.translate("FilterSearchPanel", u"PG (\u5168\u5e74\u9f62)", None))
        self.comboAIRating.setItemText(4, QCoreApplication.translate("FilterSearchPanel", u"PG-13 (\u8efd\u5fae\u306a\u8868\u73fe)", None))
        self.comboAIRating.setItemText(5, QCoreApplication.translate("FilterSearchPanel", u"R (\u4e2d\u7a0b\u5ea6)", None))
        self.comboAIRating.setItemText(6, QCoreApplication.translate("FilterSearchPanel", u"X (\u5f37\u3044\u8868\u73fe)", None))
        self.comboAIRating.setItemText(7, QCoreApplication.translate("FilterSearchPanel", u"XXX (\u904e\u6fc0\u306a\u8868\u73fe)", None))

#if QT_CONFIG(tooltip)
        self.checkboxIncludeUnrated.setToolTip(QCoreApplication.translate("FilterSearchPanel", u"PG/R\u7b49\u306e\u30ec\u30fc\u30c6\u30a3\u30f3\u30b0\u9078\u629e\u6642\u3001\u672a\u8a2d\u5b9a\u306e\u753b\u50cf\u3082\u7d50\u679c\u306b\u542b\u3081\u308b\u304b\u3069\u3046\u304b", None))
#endif // QT_CONFIG(tooltip)
        self.checkboxIncludeUnrated.setText(QCoreApplication.translate("FilterSearchPanel", u"\u30ec\u30fc\u30c6\u30a3\u30f3\u30b0\u9078\u629e\u6642\u3082\u672a\u8a2d\u5b9a\u3092\u542b\u3081\u308b", None))
