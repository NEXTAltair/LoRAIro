...
class Ui_FilterSearchPanel(object):
    ...
    def retranslateUi(self, FilterSearchPanel):
        ...
        self.comboRating.setItemText(1, QCoreApplication.translate("FilterSearchPanel", u"\u672a\u8a2d\u5b9a\u306e\u307f", None))
        self.comboRating.setItemText(2, QCoreApplication.translate("FilterSearchPanel", u"PG (\u5168\u5e74\u9f62)", None))
        self.comboRating.setItemText(3, QCoreApplication.translate("FilterSearchPanel", u"PG-13 (\u8efd\u5fae\u306a\u8868\u73fe)", None))
        self.comboRating.setItemText(4, QCoreApplication.translate("FilterSearchPanel", u"R (\u4e2d\u7a0b\u5ea6)", None))
        self.comboRating.setItemText(5, QCoreApplication.translate("FilterSearchPanel", u"X (\u5f37\u3044\u8868\u73fe)", None))
        self.comboRating.setItemText(6, QCoreApplication.translate("FilterSearchPanel", u"XXX (\u904e\u6fc0\u306a\u8868\u73fe)", None))
        ...
        self.comboAIRating.setItemText(1, QCoreApplication.translate("FilterSearchPanel", u"\u672a\u8a2d\u5b9a\u306e\u307f", None))
        self.comboAIRating.setItemText(2, QCoreApplication.translate("FilterSearchPanel", u"PG (\u5168\u5e74\u9f62)", None))
        self.comboAIRating.setItemText(3, QCoreApplication.translate("FilterSearchPanel", u"PG-13 (\u8efd\u5fae\u306a\u8868\u73fe)", None))
        self.comboAIRating.setItemText(4, QCoreApplication.translate("FilterSearchPanel", u"R (\u4e2d\u7a0b\u5ea6)", None))
        self.comboAIRating.setItemText(5, QCoreApplication.translate("FilterSearchPanel", u"X (\u5f37\u3044\u8868\u73fe)", None))
        self.comboAIRating.setItemText(6, QCoreApplication.translate("FilterSearchPanel", u"XXX (\u904e\u6fc0\u306a\u8868\u73fe)", None))
