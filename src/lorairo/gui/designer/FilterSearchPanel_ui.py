...
class Ui_FilterSearchPanel(object):
    def setupUi(self, FilterSearchPanel):
        ...
        self.radioTags.setObjectName(u"radioTags")
        ...
        self.radioCaption.setObjectName(u"radioCaption")
        ...
        self.textEditPreview.setObjectName(u"textEditPreview")
        ...
        self.buttonClear.clicked.connect(self.comboResolution.clear)
        self.buttonClear.clicked.connect(self.comboAspectRatio.clear)
    ...
    def retranslateUi(self, FilterSearchPanel):
        ...
        self.radioTags.setText(QCoreApplication.translate("FilterSearchPanel", u"\u30bf\u30b0", None))
        self.radioCaption.setText(QCoreApplication.translate("FilterSearchPanel", u"\u30ad\u30e3\u30d7\u30b7\u30e7\u30f3", None))
        ...
        self.textEditPreview.setPlaceholderText(QCoreApplication.translate("FilterSearchPanel", u"\u691c\u7d22\u7d50\u679c\u306e\u30d7\u30ec\u30d3\u30e5\u30fc\u304c\u3053\u3053\u306b\u8868\u793a\u3055\u308c\u307e\u3059", None))
