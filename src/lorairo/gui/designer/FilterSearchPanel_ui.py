...
class Ui_FilterSearchPanel:
    def setupUi(self, FilterSearchPanel):
        ...
        self.radioTags = QRadioButton(self.searchGroup)
        self.radioTags.setObjectName("radioTags")
        self.radioTags.setChecked(True)

        self.searchTypeLayout.addWidget(self.radioTags)

        self.radioCaption = QRadioButton(self.searchGroup)
        self.radioCaption.setObjectName("radioCaption")

        self.searchTypeLayout.addWidget(self.radioCaption)

        self.searchTypeSpacer = QSpacerItem(
        ...
        self.tagOptionsSpacer = QSpacerItem(
            40, 20, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum
        )
        ...
        self.textEditPreview = QTextEdit(self.searchGroup)
        self.textEditPreview.setObjectName("textEditPreview")
        sizePolicy = QSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.textEditPreview.sizePolicy().hasHeightForWidth())
        self.textEditPreview.setSizePolicy(sizePolicy)
        self.textEditPreview.setReadOnly(True)

        self.searchLayout.addWidget(self.textEditPreview)
        ...
        self.resolutionSpacer = QSpacerItem(
            40, 20, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum
        )
        ...
        self.aspectRatioSpacer = QSpacerItem(
            40, 20, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum
        )
        ...
        self.buttonClear.clicked.connect(self.comboResolution.reset)
        self.buttonClear.clicked.connect(self.comboAspectRatio.reset)
    ...
    def retranslateUi(self, FilterSearchPanel):
        FilterSearchPanel.setWindowTitle(
            QCoreApplication.translate("FilterSearchPanel", "Filter Search Panel", None)
        )
        self.searchGroup.setTitle(QCoreApplication.translate("FilterSearchPanel", "\u691c\u7d22", None))
        self.searchTypeLabel.setText(
            QCoreApplication.translate("FilterSearchPanel", "\u691c\u7d22\u5bfe\u8c61:", None)
        )
        self.radioTags.setText(QCoreApplication.translate("FilterSearchPanel", "\u30bf\u30b0", None))
        self.radioCaption.setText(
            QCoreApplication.translate("FilterSearchPanel", "\u30ad\u30e3\u30d7\u30b7\u30e7\u30f3", None)
        )
        ...
        self.tagOptionsLabel.setText(
            QCoreApplication.translate("FilterSearchPanel", "\u8907\u6570\u30bf\u30b0:", None)
        )
        self.radioAnd.setText(
            QCoreApplication.translate("FilterSearchPanel", "\u3059\u3079\u3066\u542b\u3080", None)
        )
        self.radioOr.setText(
            QCoreApplication.translate("FilterSearchPanel", "\u3044\u305a\u308c\u304b\u542b\u3080", None)
        )
        self.textEditPreview.setPlaceholderText(
            QCoreApplication.translate(
                "FilterSearchPanel",
                "\u691c\u7d22\u7d50\u679c\u306e\u30d7\u30ec\u30d3\u30e5\u30fc\u304c\u3053\u3053\u306b\u8868\u793a\u3055\u308c\u307e\u3059",
                None,
            )
        )
        self.filterGroup.setTitle(
            QCoreApplication.translate("FilterSearchPanel", "\u30d5\u30a3\u30eb\u30bf\u30fc", None)
        )
        self.resolutionLabel.setText(
            QCoreApplication.translate("FilterSearchPanel", "\u89e3\u50cf\u5ea6:", None)
        )
        self.comboResolution.setItemText(
            0, QCoreApplication.translate("FilterSearchPanel", "\u5168\u3066", None)
        )
        self.comboResolution.setItemText(
            1, QCoreApplication.translate("FilterSearchPanel", "512x512", None)
        )
        self.comboResolution.setItemText(
            2, QCoreApplication.translate("FilterSearchPanel", "1024x1024", None)
        )
        self.comboResolution.setItemText(
            3, QCoreApplication.translate("FilterSearchPanel", "1280x720", None)
        )
        self.comboResolution.setItemText(
            4, QCoreApplication.translate("FilterSearchPanel", "720x1280", None)
        )
        self.comboResolution.setItemText(
            5, QCoreApplication.translate("FilterSearchPanel", "1920x1080", None)
        )
        self.comboResolution.setItemText(
            6, QCoreApplication.translate("FilterSearchPanel", "1536x1536", None)
        )

        self.aspectRatioLabel.setText(
            QCoreApplication.translate("FilterSearchPanel", "\u30a2\u30b9\u30da\u30af\u30c8\u6bd4:", None)
        )
        self.comboAspectRatio.setItemText(
            0, QCoreApplication.translate("FilterSearchPanel", "\u5168\u3066", None)
        )
        self.comboAspectRatio.setItemText(
            1, QCoreApplication.translate("FilterSearchPanel", "\u6b63\u65b9\u5f62 (1:1)", None)
        )
        self.comboAspectRatio.setItemText(
            2, QCoreApplication.translate("FilterSearchPanel", "\u98a8\u666f (16:9)", None)
        )
        self.comboAspectRatio.setItemText(
            3, QCoreApplication.translate("FilterSearchPanel", "\u7e26\u9577 (9:16)", None)
        )
        self.comboAspectRatio.setItemText(
            4, QCoreApplication.translate("FilterSearchPanel", "\u98a8\u666f (4:3)", None)
        )
        self.comboAspectRatio.setItemText(
            5, QCoreApplication.translate("FilterSearchPanel", "\u7e26\u9577 (3:4)", None)
        )

        self.dateGroup.setTitle(
            QCoreApplication.translate("FilterSearchPanel", "\u65e5\u4ed8\u7bc4\u56f2", None)
        )
        self.checkboxDateFilter.setText(
            QCoreApplication.translate(
                "FilterSearchPanel", "\u65e5\u4ed8\u7bc4\u56f2\u3067\u30d5\u30a3\u30eb\u30bf\u30fc", None
            )
        )
        self.dateRangeSliderPlaceholder.setStyleSheet(
            QCoreApplication.translate(
                "FilterSearchPanel",
                "background-color: #f0f0f0; border: 1px dashed #ccc; padding: 10px;",
                None,
            )
        )
        self.dateRangeSliderPlaceholder.setText(
            QCoreApplication.translate(
                "FilterSearchPanel",
                "\u65e5\u4ed8\u7bc4\u56f2\u30b9\u30e9\u30a4\u30c0\u30fc (CustomRangeSlider)",
                None,
            )
        )
        self.optionsGroup.setTitle(
            QCoreApplication.translate("FilterSearchPanel", "\u30aa\u30d7\u30b7\u30e7\u30f3", None)
        )
        self.checkboxOnlyUntagged.setText(
            QCoreApplication.translate(
                "FilterSearchPanel", "\u672a\u30bf\u30b0\u753b\u50cf\u306e\u307f\u691c\u7d22", None
            )
        )
        self.checkboxOnlyUncaptioned.setText(
            QCoreApplication.translate(
                "FilterSearchPanel",
                "\u672a\u30ad\u30e3\u30d7\u30b7\u30e7\u30f3\u753b\u50cf\u306e\u307f\u691c\u7d22",
                None,
        ...
        self.checkboxExcludeDuplicates.setText(
            QCoreApplication.translate(
                "FilterSearchPanel", "\u91cd\u8907\u753b\u50cf\u3092\u9664\u5916", None
            )
        )
        self.checkboxIncludeNSFW.setText(
            QCoreApplication.translate(
                "FilterSearchPanel", "NSFW\u30b3\u30f3\u30c6\u30f3\u30c4\u3092\u542b\u3080", None
            )
        )
        self.buttonApply.setText(
            QCoreApplication.translate("FilterSearchPanel", "\u691c\u7d22\u5b9f\u884c", None)
        )
        self.buttonClear.setText(
            QCoreApplication.translate("FilterSearchPanel", "\u30af\u30ea\u30a2", None)
        )
