...
class Ui_SelectedImageDetailsWidget:
    def setupUi(self, SelectedImageDetailsWidget):
        ...
        self.sliderScore.setObjectName("sliderScore")
    ...
    def retranslateUi(self, SelectedImageDetailsWidget):
        SelectedImageDetailsWidget.setWindowTitle(QCoreApplication.translate("SelectedImageDetailsWidget", "Selected Image Details", None))
        self.groupBoxImageInfo.setTitle(QCoreApplication.translate("SelectedImageDetailsWidget", "\u753b\u50cf\u60c5\u5831", None))
        self.labelFileName.setText(QCoreApplication.translate("SelectedImageDetailsWidget", "\u30d5\u30a1\u30a4\u30eb\u540d:", None))
        self.labelFileSize.setText(QCoreApplication.translate("SelectedImageDetailsWidget", "\u30d5\u30a1\u30a4\u30eb\u30b5\u30a4\u30ba:", None))
        ...
        self.labelCreatedDate.setText(QCoreApplication.translate("SelectedImageDetailsWidget", "\u767b\u9332\u65e5:", None))
        self.labelCreatedDateValue.setText(QCoreApplication.translate("SelectedImageDetailsWidget", "-", None))
        self.labelImageSizeValue.setText(QCoreApplication.translate("SelectedImageDetailsWidget", "-", None))
        self.labelImageSize.setText(QCoreApplication.translate("SelectedImageDetailsWidget", "\u89e3\u50cf\u5ea6:", None))
        self.groupBoxAnnotationSummary.setTitle(QCoreApplication.translate("SelectedImageDetailsWidget", "\u30a2\u30ce\u30c6\u30fc\u30b7\u30e7\u30f3\u6982\u8981", None))
        self.groupBoxTags.setTitle(QCoreApplication.translate("SelectedImageDetailsWidget", "\u30bf\u30b0", None))
        self.labelTagsContent.setText(QCoreApplication.translate("SelectedImageDetailsWidget", "cat, sitting, outdoor, wooden", None))
        self.groupBoxCaptions.setTitle(QCoreApplication.translate("SelectedImageDetailsWidget", "\u30ad\u30e3\u30d7\u30b7\u30e7\u30f3", None))
        self.textEditCaptionsContent.setPlaceholderText(QCoreApplication.translate("SelectedImageDetailsWidget", "\u30ad\u30e3\u30d7\u30b7\u30e7\u30f3\u304c\u8868\u793a\u3055\u308c\u307e\u3059", None))
        self.labelRating.setText(QCoreApplication.translate("SelectedImageDetailsWidget", "Rating:", None))
        self.labelRatingValue.setText(QCoreApplication.translate("SelectedImageDetailsWidget", "PG-13", None))
        self.comboBoxRating.setItemText(0, QCoreApplication.translate("SelectedImageDetailsWidget", "PG", None))
        self.comboBoxRating.setItemText(1, QCoreApplication.translate("SelectedImageDetailsWidget", "PG-13", None))
        self.comboBoxRating.setItemText(2, QCoreApplication.translate("SelectedImageDetailsWidget", "R", None))
        self.comboBoxRating.setItemText(3, QCoreApplication.translate("SelectedImageDetailsWidget", "X", None))
        self.comboBoxRating.setItemText(4, QCoreApplication.translate("SelectedImageDetailsWidget", "XXX", None))

        self.pushButtonSaveRating.setText(QCoreApplication.translate("SelectedImageDetailsWidget", "\u4fdd\u5b58", None))
        self.labelScore.setText(QCoreApplication.translate("SelectedImageDetailsWidget", "\u30b9\u30b3\u30a2:", None))
        self.labelScoreValue.setText(QCoreApplication.translate("SelectedImageDetailsWidget", "75.4", None))
        self.pushButtonSaveScore.setText(QCoreApplication.translate("SelectedImageDetailsWidget", "\u4fdd\u5b58", None))
    # retranslateUi
