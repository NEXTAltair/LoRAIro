...
class Ui_SelectedImageDetailsWidget:
    ...
    def retranslateUi(self, SelectedImageDetailsWidget):
        ...
        self.comboBoxRating.setItemText(
            0, QCoreApplication.translate("SelectedImageDetailsWidget", "PG", None)
        )
        self.comboBoxRating.setItemText(
            1, QCoreApplication.translate("SelectedImageDetailsWidget", "PG-13", None)
        )
        self.comboBoxRating.setItemText(
            2, QCoreApplication.translate("SelectedImageDetailsWidget", "R", None)
        )
        self.comboBoxRating.setItemText(
            3, QCoreApplication.translate("SelectedImageDetailsWidget", "X", None)
        )
        self.comboBoxRating.setItemText(
            4, QCoreApplication.translate("SelectedImageDetailsWidget", "XXX", None)
        )
