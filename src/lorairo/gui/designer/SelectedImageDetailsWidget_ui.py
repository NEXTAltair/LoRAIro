...
class Ui_SelectedImageDetailsWidget:
    ...
    def retranslateUi(self, SelectedImageDetailsWidget):
        ...
        self.labelFileName.setStyleSheet(
            QCoreApplication.translate(
                "SelectedImageDetailsWidget", "font-size: 9px; font-weight: bold; color: #333;", None
            )
        )
        ...
        self.labelRatingValue.setText(
            QCoreApplication.translate("SelectedImageDetailsWidget", "PG-13", None)
        )
        self.comboBoxRating.setItemText(0, "")
        self.comboBoxRating.setItemText(
            1, QCoreApplication.translate("SelectedImageDetailsWidget", "PG", None)
        )
        self.comboBoxRating.setItemText(
            2, QCoreApplication.translate("SelectedImageDetailsWidget", "PG-13", None)
        )
        self.comboBoxRating.setItemText(
            3, QCoreApplication.translate("SelectedImageDetailsWidget", "R", None)
        )
        self.comboBoxRating.setItemText(
            4, QCoreApplication.translate("SelectedImageDetailsWidget", "X", None)
        )
        self.comboBoxRating.setItemText(
            5, QCoreApplication.translate("SelectedImageDetailsWidget", "XXX", None)
        )
        ...
        self.pushButtonSaveRating.setText(
            QCoreApplication.translate("SelectedImageDetailsWidget", "\u4fdd\u5b58", None)
        )
        self.pushButtonSaveRating.setStyleSheet(
            QCoreApplication.translate(
                "SelectedImageDetailsWidget",
                "QPushButton {\n"
                "    font-size: 10px;\n"
        ...
        self.pushButtonSaveScore.setText(
            QCoreApplication.translate("SelectedImageDetailsWidget", "\u4fdd\u5b58", None)
        )
        self.pushButtonSaveScore.setStyleSheet(
            QCoreApplication.translate(
                "SelectedImageDetailsWidget",
                "QPushButton {\n"
                "    font-size: 10px;\n"
