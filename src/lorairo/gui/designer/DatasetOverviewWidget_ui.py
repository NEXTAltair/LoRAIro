...
class Ui_DatasetOverviewWidget:
    ...
    def retranslateUi(self, DatasetOverviewWidget):
        DatasetOverviewWidget.setWindowTitle(QCoreApplication.translate("DatasetOverviewWidget", "Dataset Overview", None))
        self.metadataGroupBox.setTitle("")
        self.fileNameLabel.setText(QCoreApplication.translate("DatasetOverviewWidget", "\u30d5\u30a1\u30a4\u30eb\u540d:", None))
        self.imagePathLabel.setText(QCoreApplication.translate("DatasetOverviewWidget", "\u753b\u50cf\u30d1\u30b9:", None))
        self.extensionLabel.setText(QCoreApplication.translate("DatasetOverviewWidget", "\u62e1\u5f35\u5b50:", None))
        self.formatLabel.setText(QCoreApplication.translate("DatasetOverviewWidget", "\u30d5\u30a9\u30fc\u30de\u30c3\u30c8:", None))
        self.modeLabel.setText(QCoreApplication.translate("DatasetOverviewWidget", "\u30e2\u30fc\u30c9:", None))
        self.alphaChannelLabel.setText(QCoreApplication.translate("DatasetOverviewWidget", "\u30a2\u30eb\u30d5\u30a1\u30c1\u30e3\u30f3\u30cd\u30eb:", None))
        self.resolutionLabel.setText(QCoreApplication.translate("DatasetOverviewWidget", "\u89e3\u50cf\u5ea6:", None))
        self.aspectRatioLabel.setText(QCoreApplication.translate("DatasetOverviewWidget", "\u30a2\u30b9\u30da\u30af\u30c8\u6bd4:", None))
        self.annotationGroupBox.setTitle("")
        self.tagsLabel.setText(QCoreApplication.translate("DatasetOverviewWidget", "\u30bf\u30b0:", None))
        self.captionLabel.setText(QCoreApplication.translate("DatasetOverviewWidget", "\u30ad\u30e3\u30d7\u30b7\u30e7\u30f3:", None))
    # retranslateUi
