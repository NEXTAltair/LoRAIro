...
class Ui_AnnotationControlWidget:
    def setupUi(self, AnnotationControlWidget):
        ...
        self.checkBoxCaption.setStyleSheet(
            "QCheckBox {\n"
            "    font-size: 10px;\n"
            "    font-weight: normal;\n"
            "    spacing: 5px;\n"
        ...
        self.checkBoxTagger.setStyleSheet(
            "QCheckBox {\n"
            "    font-size: 10px;\n"
            "    font-weight: normal;\n"
            "    spacing: 5px;\n"
        ...
        self.checkBoxScorer.setStyleSheet(
            "QCheckBox {\n"
            "    font-size: 10px;\n"
            "    font-weight: normal;\n"
            "    spacing: 5px;\n"
        ...
        self.checkBoxWebAPI.setStyleSheet(
            "QCheckBox {\n"
            "    font-size: 10px;\n"
            "    font-weight: normal;\n"
            "    spacing: 5px;\n"
        ...
        self.checkBoxLocal.setStyleSheet(
            "QCheckBox {\n"
            "    font-size: 10px;\n"
            "    font-weight: normal;\n"
            "    spacing: 5px;\n"
        ...
        self.horizontalSpacerProviders = QSpacerItem(
        ...
        self.checkBoxLowResolution.setStyleSheet(
            "QCheckBox {\n"
            "    font-size: 10px;\n"
            "    font-weight: normal;\n"
            "    spacing: 5px;\n"
        ...
        self.checkBoxBatchMode.setStyleSheet(
            "QCheckBox {\n"
            "    font-size: 10px;\n"
            "    font-weight: normal;\n"
            "    spacing: 5px;\n"
    ...
    def retranslateUi(self, AnnotationControlWidget):
        AnnotationControlWidget.setWindowTitle(
            QCoreApplication.translate("AnnotationControlWidget", "Annotation Control", None)
        )
        self.groupBoxFunctionType.setTitle(
            QCoreApplication.translate("AnnotationControlWidget", "\u6a5f\u80fd\u30bf\u30a4\u30d7", None)
        )
        self.checkBoxCaption.setText(
            QCoreApplication.translate("AnnotationControlWidget", "Caption\u751f\u6210", None)
        )
        self.checkBoxTagger.setText(
            QCoreApplication.translate("AnnotationControlWidget", "Tag\u751f\u6210", None)
        )
        self.checkBoxScorer.setText(
            QCoreApplication.translate("AnnotationControlWidget", "\u54c1\u8cea\u30b9\u30b3\u30a2", None)
        )
        self.groupBoxProviderSelection.setTitle(
            QCoreApplication.translate(
                "AnnotationControlWidget", "\u5b9f\u884c\u74b0\u5883\u9078\u629e", None
            )
        )
        self.checkBoxWebAPI.setText(QCoreApplication.translate("AnnotationControlWidget", "Web API", None))
        self.checkBoxLocal.setText(
            QCoreApplication.translate(
                "AnnotationControlWidget", "\u30ed\u30fc\u30ab\u30eb\u30e2\u30c7\u30eb", None
            )
        )
        self.groupBoxModelSelection.setTitle(
            QCoreApplication.translate("AnnotationControlWidget", "\u30e2\u30c7\u30eb\u9078\u629e", None)
        )
        self.groupBoxOptions.setTitle(
            QCoreApplication.translate("AnnotationControlWidget", "\u30aa\u30d7\u30b7\u30e7\u30f3", None)
        )
        self.checkBoxLowResolution.setText(
            QCoreApplication.translate(
                "AnnotationControlWidget",
                "API\u8ca0\u8377\u8efd\u6e1b\u7528512x512\u30d9\u30fc\u30b9\u306e\u753b\u50cf\u3092\u4f7f\u7528",
                None,
            )
        )
        self.checkBoxBatchMode.setText(
            QCoreApplication.translate(
                "AnnotationControlWidget", "\u30d0\u30c3\u30c1\u51e6\u7406\u30e2\u30fc\u30c9", None
            )
        )
        ...
        self.pushButtonStart.setText(
            QCoreApplication.translate("AnnotationControlWidget", "\u5b9f\u884c", None)
        )
