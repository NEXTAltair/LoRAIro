...
class Ui_ModelSelectionWidget:
    def setupUi(self, ModelSelectionWidget):
        ...
        ModelSelectionWidget.setStyleSheet(
            "/* Provider Group Label Style */\n"
        ...
        self.btnSelectRecommended.setObjectName("btnSelectRecommended")
        self.btnSelectRecommended.setMaximumSize(QSize(65, 24))
        self.btnSelectRecommended.setStyleSheet(
            "QPushButton {\n"
            "    font-size: 10px;\n"
            "    padding: 3px 6px;\n"
    ...
    def retranslateUi(self, ModelSelectionWidget):
        ...
        self.btnSelectAll.setText(
            QCoreApplication.translate("ModelSelectionWidget", "\u5168\u9078\u629e", None)
        )
        self.btnDeselectAll.setText(
            QCoreApplication.translate("ModelSelectionWidget", "\u5168\u89e3\u9664", None)
        )
        # if QT_CONFIG(tooltip)
        self.btnSelectRecommended.setToolTip(
            QCoreApplication.translate(
                "ModelSelectionWidget", "\u63a8\u5968\u30e2\u30c7\u30eb\u3092\u81ea\u52d5\u9078\u629e", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.btnSelectRecommended.setText(
            QCoreApplication.translate("ModelSelectionWidget", "\u63a8\u5968\u9078\u629e", None)
        )
