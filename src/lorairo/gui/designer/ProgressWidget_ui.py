...
class Ui_ProgressWidget:
    ...
    def retranslateUi(self, ProgressWidget):
        ...
        self.statusLabel.setText(QCoreApplication.translate("ProgressWidget", "\u5f85\u6a5f\u4e2d...", None))
        self.progressBar.setFormat(QCoreApplication.translate("ProgressWidget", "%v / %m", None))
        self.cancelButton.setText(QCoreApplication.translate("ProgressWidget", "\u30ad\u30e3\u30f3\u30bb\u30eb", None))
    # retranslateUi
