...
class Ui_ConfigurationWindow:
    ...
    def retranslateUi(self, ConfigurationWindow):
        ...
        self.groupBoxFolders.setTitle(QCoreApplication.translate("ConfigurationWindow", "\u30d5\u30a9\u30eb\u30c0\u8a2d\u5b9a", None))
        self.groupBoxApiSettings.setTitle(QCoreApplication.translate("ConfigurationWindow", "API KEY", None))
        self.labelOpenAiKey.setText(QCoreApplication.translate("ConfigurationWindow", "OpenAI", None))
        self.labelGoogleKey.setText(QCoreApplication.translate("ConfigurationWindow", "Google AI Studio", None))
        self.labelAnthropicKey.setText(QCoreApplication.translate("ConfigurationWindow", "Anthropic", None))
        self.groupBoxHuggingFaceSettings.setTitle(QCoreApplication.translate("ConfigurationWindow", "Hugging Face", None))
        self.labelHfUsername.setText(QCoreApplication.translate("ConfigurationWindow", "\u30e6\u30fc\u30b6\u30fc\u540d:", None))
        self.labelHfRepoName.setText(QCoreApplication.translate("ConfigurationWindow", "\u30ea\u30dd\u30b8\u30c8\u30ea\u540d:", None))
        self.labelHfToken.setText(QCoreApplication.translate("ConfigurationWindow", "\u30c8\u30fc\u30af\u30f3:", None))
        self.groupBoxLogSettings.setTitle(QCoreApplication.translate("ConfigurationWindow", "\u30ed\u30b0\u8a2d\u5b9a", None))
        self.labelLogLevel.setText(QCoreApplication.translate("ConfigurationWindow", "\u30ed\u30b0\u30ec\u30d9\u30eb:", None))
        self.buttonSave.setText(QCoreApplication.translate("ConfigurationWindow", "\u4fdd\u5b58", None))
        self.buttonSaveAs.setText(QCoreApplication.translate("ConfigurationWindow", "\u540d\u524d\u3092\u4ed8\u3051\u3066\u4fdd\u5b58", None))
    # retranslateUi
