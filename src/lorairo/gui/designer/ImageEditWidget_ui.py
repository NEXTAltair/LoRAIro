...
class Ui_ImageEditWidget:
    ...
    def retranslateUi(self, ImageEditWidget):
        ...
        ___qtablewidgetitem.setText(
            QCoreApplication.translate("ImageEditWidget", "\u30b5\u30e0\u30cd\u30a4\u30eb", None)
        )
        ___qtablewidgetitem1 = self.tableWidgetImageList.horizontalHeaderItem(1)
        ___qtablewidgetitem1.setText(
            QCoreApplication.translate("ImageEditWidget", "\u30d5\u30a1\u30a4\u30eb\u540d", None)
        )
        ...
        ___qtablewidgetitem3.setText(
            QCoreApplication.translate("ImageEditWidget", "\u30b5\u30a4\u30ba", None)
        )
        ___qtablewidgetitem4 = self.tableWidgetImageList.horizontalHeaderItem(4)
        ___qtablewidgetitem4.setText(
            QCoreApplication.translate("ImageEditWidget", "\u65e2\u5b58\u30bf\u30b0", None)
        )
        ___qtablewidgetitem5 = self.tableWidgetImageList.horizontalHeaderItem(5)
        ___qtablewidgetitem5.setText(
            QCoreApplication.translate(
                "ImageEditWidget", "\u65e2\u5b58\u30ad\u30e3\u30d7\u30b7\u30e7\u30f3", None
            )
        )
        self.labelPreviewTitle.setText(
            QCoreApplication.translate("ImageEditWidget", "\u30d7\u30ec\u30d3\u30e5\u30fc", None)
        )
        self.groupBoxEditOptions.setTitle(
            QCoreApplication.translate(
                "ImageEditWidget", "\u7de8\u96c6\u30aa\u30d7\u30b7\u30e7\u30f3", None
            )
        )
        self.labelResizeOption.setText(
            QCoreApplication.translate("ImageEditWidget", "\u30ea\u30b5\u30a4\u30ba:", None)
        )
        self.comboBoxResizeOption.setItemText(
            0, QCoreApplication.translate("ImageEditWidget", "768x768", None)
        )
        self.comboBoxResizeOption.setItemText(
            1, QCoreApplication.translate("ImageEditWidget", "1024x1024", None)
        )

        self.labelUpscaler.setText(
            QCoreApplication.translate(
                "ImageEditWidget", "\u30a2\u30c3\u30d7\u30b9\u30b1\u30fc\u30e9\u30fc", None
            )
        )
        self.comboBoxUpscaler.setItemText(0, QCoreApplication.translate("ImageEditWidget", "None", None))

        self.pushButtonStartProcess.setText(
            QCoreApplication.translate("ImageEditWidget", "\u51e6\u7406\u958b\u59cb", None)
        )
