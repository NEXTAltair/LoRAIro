...
class Ui_ImageEditWidget:
    def setupUi(self, ImageEditWidget):
        if not ImageEditWidget.objectName():
            ImageEditWidget.setObjectName("ImageEditWidget")
        ...
        self.splitterMainContent.setObjectName("splitterMainContent")
        ...
        self.tableWidgetImageList.setObjectName("tableWidgetImageList")
        ...
        self.widget_PreviewArea_2.setObjectName("widget_PreviewArea_2")
        self.verticalImagePreview = QVBoxLayout(self.widget_PreviewArea_2)
        self.verticalImagePreview.setSpacing(0)
        self.verticalImagePreview.setObjectName("verticalImagePreview")
        ...
        self.horizontalLayoutControlArea.setObjectName("horizontalLayoutControlArea")
        self.groupBoxEditOptions = QGroupBox(ImageEditWidget)
        self.groupBoxEditOptions.setObjectName("groupBoxEditOptions")
        self.horizontalLayout_EditOptions_2 = QHBoxLayout(self.groupBoxEditOptions)
        self.horizontalLayout_EditOptions_2.setObjectName("horizontalLayout_EditOptions_2")
        self.labelResizeOption = QLabel(self.groupBoxEditOptions)
        self.labelResizeOption.setObjectName("labelResizeOption")
        sizePolicy4 = QSizePolicy(QSizePolicy.Policy.Preferred, QSizePolicy.Policy.Fixed)
        sizePolicy4.setHorizontalStretch(0)
        sizePolicy4.setVerticalStretch(0)
        sizePolicy4.setHeightForWidth(self.labelResizeOption.sizePolicy().hasHeightForWidth())
        self.labelResizeOption.setSizePolicy(sizePolicy4)
        ...
        self.comboBoxResizeOption.addItem("")
        self.comboBoxResizeOption.setObjectName("comboBoxResizeOption")
        sizePolicy5 = QSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Preferred)
        sizePolicy5.setHorizontalStretch(0)
        sizePolicy5.setVerticalStretch(0)
        sizePolicy5.setHeightForWidth(self.comboBoxResizeOption.sizePolicy().hasHeightForWidth())
        self.comboBoxResizeOption.setSizePolicy(sizePolicy5)
        ...
        self.labelUpscaler.setObjectName("labelUpscaler")
        sizePolicy4.setHeightForWidth(self.labelUpscaler.sizePolicy().hasHeightForWidth())
        self.labelUpscaler.setSizePolicy(sizePolicy4)
        ...
        self.comboBoxUpscaler.setObjectName("comboBoxUpscaler")
        self.comboBoxUpscaler.setCurrentText("None")
        sizePolicy5.setHeightForWidth(self.comboBoxUpscaler.sizePolicy().hasHeightForWidth())
        self.comboBoxUpscaler.setSizePolicy(sizePolicy5)
        ...
        self.pushButtonStartProcess.setObjectName("pushButtonStartProcess")
        sizePolicy6 = QSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Fixed)
        sizePolicy6.setHorizontalStretch(0)
        sizePolicy6.setVerticalStretch(0)
        sizePolicy6.setHeightForWidth(self.pushButtonStartProcess.sizePolicy().hasHeightForWidth())
        self.pushButtonStartProcess.setSizePolicy(sizePolicy6)
    ...
    def retranslateUi(self, ImageEditWidget):
        ImageEditWidget.setWindowTitle(QCoreApplication.translate("ImageEditWidget", "Form", None))
        ___qtablewidgetitem = self.tableWidgetImageList.horizontalHeaderItem(0)
        ___qtablewidgetitem.setText(QCoreApplication.translate("ImageEditWidget", "\u30b5\u30e0\u30cd\u30a4\u30eb", None))
        ___qtablewidgetitem1 = self.tableWidgetImageList.horizontalHeaderItem(1)
        ___qtablewidgetitem1.setText(QCoreApplication.translate("ImageEditWidget", "\u30d5\u30a1\u30a4\u30eb\u540d", None))
        ___qtablewidgetitem2 = self.tableWidgetImageList.horizontalHeaderItem(2)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("ImageEditWidget", "\u30d1\u30b9", None))
        ___qtablewidgetitem3 = self.tableWidgetImageList.horizontalHeaderItem(3)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("ImageEditWidget", "\u30b5\u30a4\u30ba", None))
        ___qtablewidgetitem4 = self.tableWidgetImageList.horizontalHeaderItem(4)
        ___qtablewidgetitem4.setText(QCoreApplication.translate("ImageEditWidget", "\u65e2\u5b58\u30bf\u30b0", None))
        ___qtablewidgetitem5 = self.tableWidgetImageList.horizontalHeaderItem(5)
        ___qtablewidgetitem5.setText(QCoreApplication.translate("ImageEditWidget", "\u65e2\u5b58\u30ad\u30e3\u30d7\u30b7\u30e7\u30f3", None))
        self.labelPreviewTitle.setText(QCoreApplication.translate("ImageEditWidget", "\u30d7\u30ec\u30d3\u30e5\u30fc", None))
        self.groupBoxEditOptions.setTitle(QCoreApplication.translate("ImageEditWidget", "\u7de8\u96c6\u30aa\u30d7\u30b7\u30e7\u30f3", None))
        self.labelResizeOption.setText(QCoreApplication.translate("ImageEditWidget", "\u30ea\u30b5\u30a4\u30ba:", None))
        self.comboBoxResizeOption.setItemText(0, QCoreApplication.translate("ImageEditWidget", "768x768", None))
        self.comboBoxResizeOption.setItemText(1, QCoreApplication.translate("ImageEditWidget", "1024x1024", None))

        self.labelUpscaler.setText(QCoreApplication.translate("ImageEditWidget", "\u30a2\u30c3\u30d7\u30b9\u30b1\u30fc\u30e9\u30fc", None))
        self.comboBoxUpscaler.setItemText(0, QCoreApplication.translate("ImageEditWidget", "None", None))

        self.pushButtonStartProcess.setText(QCoreApplication.translate("ImageEditWidget", "\u51e6\u7406\u958b\u59cb", None))
    # retranslateUi
