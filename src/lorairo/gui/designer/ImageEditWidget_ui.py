...
class Ui_ImageEditWidget(object):
    ...
    def retranslateUi(self, ImageEditWidget):
        ...
        self.comboBoxResizeOption.setItemText(0, QCoreApplication.translate("ImageEditWidget", u"768x768", None))
        self.comboBoxResizeOption.setItemText(1, QCoreApplication.translate("ImageEditWidget", u"1024x1024", None))
