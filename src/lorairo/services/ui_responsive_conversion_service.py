...
class UIResponsiveConversionService:
    ...
    def _should_apply_pattern_to_layout(self, layout: ET.Element, pattern: ResponsivePattern) -> bool:
        """レイアウト適用判定
    ...
    def _get_widget_size_policy(self, widget: ET.Element) -> dict[str, str | None]:
        ...
        Returns:
            sizePolicyの詳細
        """
        policy_info = {"hsizetype": None, "vsizetype": None, "horstretch": None, "verstretch": None}
