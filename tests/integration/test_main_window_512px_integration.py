...
class TestMainWindow512pxIntegration:
    ...
    def _wait_for_batch_completion(self, main_window, timeout_ms=30000):
        ...
        # プログレスコントローラーの完了を監視
        if (hasattr(main_window.progress_controller, 'worker') and 
            main_window.progress_controller.worker):
            ...
            for image_id in image_ids:
                ...
                if result_path and result_path.exists():
                    with Image.open(result_path) as processed_img:
                        ...
                        scale_factor = max(processed_width/original_width, processed_height/original_height)
