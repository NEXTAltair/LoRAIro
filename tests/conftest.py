...
# Issue #754: model installer API (明示モデルインストール)
_ial_mock.ModelInstallCancelledError = type("ModelInstallCancelledError", (Exception,), {})
_ial_mock.ModelInstallProgress = unittest.mock.MagicMock()
_ial_mock.is_model_installed = unittest.mock.MagicMock(return_value=True)
_ial_mock.install_model = unittest.mock.MagicMock()
