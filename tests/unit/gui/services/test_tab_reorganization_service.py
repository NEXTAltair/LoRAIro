...
import pytest
from PySide6.QtWidgets import QGroupBox, QSplitter, QTabWidget, QWidget
...
class TestIntegrationWithRealWidgets:
    ...
    def test_validate_with_complete_widget_hierarchy(self, qapp):
        ...
        splitter.setObjectName("splitterBatchTagMain")

        # splitter の子としてプレースホルダーと操作パネルを配置
        placeholder1 = QWidget(splitter)
        placeholder1.setObjectName("batchTagWidgetPlaceholder")

        operations_group = QGroupBox("操作", splitter)
        ...
        placeholder2.setObjectName("batchTagInputPlaceholder")

        placeholder3 = QWidget(operations_group)
        placeholder3.setObjectName("annotationDisplayPlaceholder")

        placeholder4 = QWidget(annotation_group)
        placeholder4.setObjectName("annotationFilterPlaceholder")

        placeholder5 = QWidget(annotation_group)
        placeholder5.setObjectName("modelSelectionPlaceholder")
