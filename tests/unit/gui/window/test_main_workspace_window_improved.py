...
class TestMainWorkspaceWindowImproved:
    ...
    def minimal_main_window(self, qapp, real_config_service, real_db_manager, real_dataset_state, mock_fsm):
        ...
        with patch("lorairo.gui.window.main_workspace_window.FilterSearchPanel") as mock_filter, \
            ...
            with patch("lorairo.gui.window.main_workspace_window.WorkerService") as mock_worker_service_class:
