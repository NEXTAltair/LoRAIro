"""EnhancedAnnotationService ユニットテスト
...
class TestEnhancedAnnotationServiceInitialization:
    """EnhancedAnnotationService 初期化テスト"""
    ...
    def test_initialization_with_parent(self, mock_get_container):
        ...
        service = EnhancedAnnotationService(parent=mock_parent)
...
class TestEnhancedAnnotationServiceModelSync:
    """EnhancedAnnotationService モデル同期テスト"""
...
class TestEnhancedAnnotationServiceModelRetrieval:
    """EnhancedAnnotationService モデル取得テスト"""
...
class TestEnhancedAnnotationServiceSingleAnnotation:
    """EnhancedAnnotationService 単発アノテーションテスト"""
...
class TestEnhancedAnnotationServiceBatchAnnotation:
    """EnhancedAnnotationService バッチアノテーションテスト"""
...
class TestEnhancedAnnotationServiceUtilities:
    """EnhancedAnnotationService ユーティリティ機能テスト"""
...
class TestEnhancedAnnotationServiceInputValidation:
    """EnhancedAnnotationService 入力検証テスト"""
...
# 境界値・エッジケーステスト
class TestEnhancedAnnotationServiceEdgeCases:
    """EnhancedAnnotationService 境界値・エッジケーステスト"""
...
class TestEnhancedAnnotationServiceIntegration:
    """EnhancedAnnotationService 統合テスト"""
